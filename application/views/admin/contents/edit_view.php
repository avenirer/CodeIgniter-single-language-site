...
<div class="container" style="margin-top:60px;">
    <div class="row">
        <div class="col-lg-12">
            <h1>Edit <?php echo str_replace('_',' ',$content->content_type);?> "<?php echo $content->short_title;?>"</h1>
            <?php echo form_open();?>
            ...
            if(!empty($slugs)) {
                foreach ($slugs as $slug) {
                    echo(($slug->redirect == 0) ? anchor($slug->url,$slug->url,'target="_blank"') : $slug->url);
                    echo '<br />';
                }
            }
            echo '</div>';
            ...
            <?php echo form_hidden('content_id',$content->id);?>
            <?php
            $submit_button = 'Edit content';
