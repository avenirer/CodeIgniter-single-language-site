    ...
    <div class="row">
        <div class="col-lg-12" style="margin-top: 10px;">
            ...
            if(!empty($users))
            {
                ...
                echo '<tr><td>ID</td><td>Username</td><td>Name</td><td>Email</td><td>Last login</td><td>Operations</td></tr>';
                foreach($users as $user)
                {
                    ...
                    echo '&nbsp;'.anchor('admin/users/logs/'.$user->id,'<span class="glyphicon glyphicon-book"></span>');
                    echo '</td>';
                    echo '</tr>';
                }
                echo '</table>';
